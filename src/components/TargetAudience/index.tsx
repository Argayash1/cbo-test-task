...
export const TargetAudience = () => {
	const targetAudienceListItems = targetAudienceItems.map(
		(targetAudienceItem, index) => (
			<li key={index}>
				<TargetAudienceCard
	...
	return (
		<section className={styles.root}>
			<div className={styles.container}>
				<SectionTitle
					titleText='Этот практикум необходим:'
					place='target-audience'
				/>
				...
				<CTA
					path='#'
					linkText='Узнать специальную цену для команды'
